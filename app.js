...
function useIndicadoresTopbar() {
  const [datos, setDatos] = useState({ routersOperativos: null, routersSinRespuesta: null });
    ...
    <div class="app-shell">
      ...
      <header class="topbar">
        ...
        <div class="topbar-derecha">
          <span class="topbar-indicador"><i class="fa-solid fa-server"></i> ${routersOperativos ?? '—'} operativos</span>
          ${routersSinRespuesta > 0 && html`
            <span class="topbar-indicador critico" style=${{ cursor: 'pointer' }} onClick=${() => setRuta('alertas')}>
              <i class="fa-solid fa-triangle-exclamation"></i> ${routersSinRespuesta} sin respuesta
            </span>
          `}
      ...
      <main class="main-content">
        ${ruta === 'inicio'
          ...
          : ruta === 'cuentas'
          ? html`<${ModuloCuentasGlobal} navegarACliente=${navegarACliente} />`
          : ruta === 'pagos'
          ? html`<${ModuloPagosGlobal} navegarACliente=${navegarACliente} />`
          : ruta === 'planes'
